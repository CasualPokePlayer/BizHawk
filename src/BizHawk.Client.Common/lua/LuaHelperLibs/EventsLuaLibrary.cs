...
namespace BizHawk.Client.Common
{
	...
	public sealed class EventsLuaLibrary : LuaLibraryBase
	{
		...
		public string OnFrameEnd([LuaFunctionParam] object luaf, string name = null)
			=> _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_POSTFRAME, LogOutputCallback, CurrentFile, name)
				.Guid.ToString();
		...
		public string OnFrameStart([LuaFunctionParam] object luaf, string name = null)
			=> _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_PREFRAME, LogOutputCallback, CurrentFile, name)
				.Guid.ToString();
		...
		public string OnInputPoll([LuaFunctionParam] object luaf, string name = null)
		{
			var nlf = _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_INPUTPOLL, LogOutputCallback, CurrentFile, name);
		...
		public string OnLoadState([LuaFunctionParam] object luaf, string name = null)
			=> _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_LOADSTATE, LogOutputCallback, CurrentFile, name)
				.Guid.ToString();

		[LuaDeprecatedMethod]
		[LuaMethod("onmemoryexecute", "Fires after the given address is executed by the core")]
		public string OnMemoryExecute(
			[LuaFunctionParam] object luaf,
			uint address,
			string name = null,
			string scope = null)
		{
			...
			string scope = null)
		{
			try
			{
					...
					DebuggableCore.MemoryCallbacks.ExecuteCallbacksAvailable)
				{
					...
					var nlf = _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_MEMEXEC, LogOutputCallback, CurrentFile, name);
			...
			string scope = null)
		{
			try
			{
					...
					&& DebuggableCore.MemoryCallbacks.ExecuteCallbacksAvailable)
				{
					...
					var nlf = _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_MEMEXECANY, LogOutputCallback, CurrentFile, name);
			...
			string scope = null)
		{
			try
			{
				if (DebuggableCore?.MemoryCallbacksAvailable() == true)
				{
					...
					var nlf = _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_MEMREAD, LogOutputCallback, CurrentFile, name);
					DebuggableCore.MemoryCallbacks.Add(
...
//			Log("Deprecated function event.onmemorywrite(...) used, replace the call with event.on_bus_write(...).");
			...
			string scope = null)
		{
			try
			{
				if (DebuggableCore?.MemoryCallbacksAvailable() == true)
				{
					...
					var nlf = _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_MEMWRITE, LogOutputCallback, CurrentFile, name);
					DebuggableCore.MemoryCallbacks.Add(
		...
		public string OnSaveState([LuaFunctionParam] object luaf, string name = null)
			=> _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_SAVESTATE, LogOutputCallback, CurrentFile, name)
				.Guid.ToString();
		...
		public string OnExit([LuaFunctionParam] object luaf, string name = null)
			=> _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_ENGINESTOP, LogOutputCallback, CurrentFile, name)
				.Guid.ToString();
		...
		public string OnConsoleClose([LuaFunctionParam] object luaf, string name = null)
			=> _luaLibsImpl.CreateAndRegisterNamedFunction(LuaTableHelper.ParseFunction(luaf), NamedLuaFunction.EVENT_TYPE_CONSOLECLOSE, LogOutputCallback, CurrentFile, name)
				.Guid.ToString();
